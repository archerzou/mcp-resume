...
class LLMProviders:
    ...
    def create_system_message(context: str) -> str:
        ...
        return f"""You are an AI assistant helping users explore Archer Zou's professional resume. 
...
- Focus on relevant details from the provided context"""
    ...
    def chat_ollama(model: str, messages: List[Dict], context: str = "") -> str:
        ...
        try:
            formatted_prompt = f"""You are an AI assistant helping users explore Archer Zou's professional resume. 
