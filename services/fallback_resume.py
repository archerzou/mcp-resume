...
Loads resume data from the data/archer_zou_resume.json file.
...
class FallbackResumeService:
    ...
    def _load_resume_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if REQUESTS_AVAILABLE:
                gist_url = "https://gist.github.com/archerzou/979bd28756fc6dc12782350e19dd6d05/raw/resume.json"
            ...
            # Try resume.json first, then archer_zou_resume.json as fallback
            json_files = ["data/resume.json", "data/archer_zou_resume.json"]
    ...
    def _convert_json_resume_format(self, json_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        personal = {
            "name": basics.get("name", "Archer Zou"),
            "title": basics.get("label", "Senior Full-Stack Developer & Data Scientist"),
