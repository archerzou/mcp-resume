...
class UIComponents:
    ...
    def render_header(data_status: str, ai_status: str, api_key_status: str):
        ...
        <div style='text-align: center;'>
            ...
            <p style='font-size: 18px; color: #666; margin: 0 0 0.5rem 0; font-weight: 500;'>
                Intelligent CV Chat Interface &nbsp;|&nbsp; Ask anything about Archer's experience 
            </p>
        ...
        try:
            ...
            if os.path.exists(pdf_path):
                ...
                return st.download_button(
                    label="📄 Download CV",
                    data=cv_pdf_data,
                    file_name="Archer Zou.pdf",
                    mime="application/pdf",
                    use_container_width=True,
                    help="Download Archer's CV in PDF format"
                )
            else:
    ...
    def render_chat_messages(messages: List[Dict[str, Any]]):
        ...
        for idx, message in enumerate(messages):
            display_name = "ArcherGPT" if message["role"] == "assistant" else "User"
