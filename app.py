...
This application provides an intelligent chat interface for exploring Archer Zou's resume.
    ...
    with st.sidebar:
        ...
        with st.expander("Help & Tips", expanded=False):
            ...
            **Need Custom AI Resume Solutions?**
            - Contact [Archer](https://www.linkedin.com/in/archer-zou/) for enterprise solutions
            """)
...
def main():
    ...
    # Chat input
    if user_input := st.chat_input("💬 Ask ArcherGPT here..."):
